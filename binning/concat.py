...
def process_config_file(filepath, rel_path):
    """Read a .yaml file and return its content with a header."""
    try:
        with open(filepath, "r", encoding="utf-8") as f:
            content = f.read()
    except Exception as e:
    ...
    for root, dirs, files in os.walk(base_dir):
        for file in files:
            ...
            if lower.endswith(".py"):
                ...
                output_lines.append(process_config_file(full_path, rel_path))
